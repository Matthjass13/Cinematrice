...
<?php
$decouverte = getDecouverte($_POST["idDecouverte"]);
$films = getFilms();
?>

<div class="bdElement">

    <form action="modifyDecouverte.php" method="POST">

        <h1>Modification de la découverte</h1>
        ...
        <div class="bdElement2">
                ...
                <div class="col-4">
                    ...
                    <select class="form-control" name="idFilm">
                        ...
                        foreach ($films as $film) :
                            if($decouverte['IdFilm'] == $film['IdFilm']) $s="selected"; else $s = "";
            ...
            <label for="decouverte">Texte de la découverte :</label>
            <textarea class="form-control" name="decouverte" rows="5" cols="30"><?php echo $decouverte["Decouverte"];?></textarea><br>

            <button type=submit name="idDecouverte" value=<?php echo $decouverte["IdDecouverte"];?>> Modifier</button>
